...
public class MerchantDetailActivity extends BaseActivity {
    ...
    @BindView(R.id.img_add_merchant) ImageView imgAddZheng;
    ...
    @BindView(R.id.et_bussisness_num) EditText etbusNum;
    ...
    public void initListeners() {
        ...
        baseBeanSubscriberOnNextListener=new SubscriberOnNextListener<String>() {
            ...
            public void onNext(String s) {
                TastyToast.makeText(MerchantDetailActivity.this,"审核信息提交成功",TastyToast.LENGTH_SHORT,TastyToast.SUCCESS);
                startActivity(new Intent(MerchantDetailActivity.this, StatusActivity.class));
                finish();
            }
        };
    }
    ...
    @OnClick({R.id.img_back, R.id.img_add_merchant, R.id.imageView2, R.id.img_add_hand,R.id.btn_next, R.id.imageView3})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_back:
                finish();
                break;
            case R.id.img_add_merchant:
                MultiImageSelectorActivity.startSelect(MerchantDetailActivity.this, 0, 1, 0);
                break;
            case R.id.imageView2:
                Intent intent=new Intent(MerchantDetailActivity.this,TipExampleActivity.class);
                intent.putExtra("type",2);//营业执照
                startActivity(intent);
                break;
            case R.id.img_add_hand:
                MultiImageSelectorActivity.startSelect(MerchantDetailActivity.this, 1, 1, 0);
                break;
            case R.id.imageView3:
                Intent intent2=new Intent(MerchantDetailActivity.this,TipExampleActivity.class);
    ...
    private boolean checkInfo() {
        ...
        String busNum=etbusNum.getText().toString();

        if (null==filePath||filePath.equals("")) {
            TastyToast.makeText(this, "请上传营业执照", TastyToast.LENGTH_LONG, TastyToast.WARNING);
            return false;
            ...
            return false;
        }else if (null==busNum||busNum.equals("")) {
            TastyToast.makeText(this, "请填写营业执照", TastyToast.LENGTH_LONG, TastyToast.WARNING);
            return false;
        ...
        merchantBean.setBussinessImg(url1);
        ...
        merchantBean.setPermissions(1); //1是外部商家，2是个人商户，0是内部
        return true;
    }
    @Override
