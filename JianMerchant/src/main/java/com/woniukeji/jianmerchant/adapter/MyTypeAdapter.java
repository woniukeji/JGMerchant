...
public class MyTypeAdapter extends RecyclerView.Adapter<MyTypeAdapter.ViewHolder> {
    private BaseBean<List<TypeBean>> dataSet;
    private Context context;


    public MyTypeAdapter(BaseBean<List<TypeBean>> dataSet, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.tv_select.setText(dataSet.getData().get(position).getType());
